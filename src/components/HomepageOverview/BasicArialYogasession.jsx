  ...
  const benefits = [
    {
      icon: '💪',
      title: 'Strength',
      description: 'Build core and upper body power with suspension training'
    },
    {
      icon: '🤸',
      title: 'Flexibility',
      description: 'Deepen stretches with gravity-assisted movements'
    },
    {
      icon: '🦴',
      title: 'Spinal Decompression',
      description: 'Release tension and elongate the spine safely'
    },
    {
      icon: '🎯',
      title: 'Body Awareness',
      description: 'Enhance proprioception and spatial understanding'
    }
  ];

  const poses = [
    { name: 'Supported Savasana', sanskrit: 'Hammock Shavasana' },
    { name: 'Aerial Forward Fold', sanskrit: 'Suspended Uttanasana' },
    { name: 'Flying Downward Dog', sanskrit: 'Adho Mukha Svanasana' },
    { name: 'Cocoon Pose', sanskrit: 'Kosha Asana' },
    { name: 'Aerial Pigeon', sanskrit: 'Suspended Kapotasana' },
    { name: 'Inverted Postures', sanskrit: 'Viparita Asana' }
  ];
  ...
  return (
    <div className={styles.hathaYogaPage}>
        ...
        <div className="container">
          <div className="row align-items-center min-vh-100">
            <div className="col-lg-8 mx-auto text-center">
              <div className={styles.heroBadge}>Suspended Practice</div>
              <h1 className={`display-3 fw-bold mb-4 ${styles.heroTitle}`}>
                Basic Aerial Yoga Session
              </h1>
              <p className={`lead ${styles.heroDescription}`}>
                Basic aerial yoga introduces supported postures using fabric hammocks to improve 
                strength, flexibility, spinal decompression, and body awareness.
              </p>
      ...
      <section className={`py-5 ${styles.posesSection}`}>
        <div className="container py-5">
          <div className="text-center mb-5">
            <h2 className={styles.sectionTitle}>Foundational Aerial Poses</h2>
            <div className={`${styles.titleUnderline} bg-white`}></div>
            <p className="text-white-50 mt-3">Essential hammock-supported postures</p>
          </div>
          <div className="row g-4">
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 mb-4 mb-lg-0">
              <div className={styles.practiceImageWrapper}>
                <img src={Practice} alt="Basic Aerial Yoga Session"/>
              </div>
            </div>
            <div className="col-lg-6">
              ...
              <div className={styles.practiceContent}>
                <div className={styles.practiceItem}>
                  ...
                  <div>
                    <h5>Hammock Support</h5>
                    <p>Learn to use the silk fabric for balance and assistance</p>
                  </div>
                </div>
                <div className={styles.practiceItem}>
                  <div className={styles.practiceIcon}>🔄</div>
                  <div>
                    <h5>Gravity Assistance</h5>
                    <p>Explore inversions and stretches with reduced pressure</p>
                  </div>
                </div>
                <div className={styles.practiceItem}>
                  <div className={styles.practiceIcon}>🎪</div>
                  <div>
                    <h5>Playful Movement</h5>
                    <p>Experience joy and freedom in suspended practice</p>
                  </div>
                </div>
              </div>
            </div>
...
export default BasicAerialYoga;