  ...
  const benefits = [
    {
      icon: '🤫',
      title: 'Inner Silence',
      description: 'Quiet the mental chatter and find deep peace within'
    },
    {
      icon: '🎯',
      title: 'Concentration',
      description: 'Develop sustained focus and one-pointed awareness'
    },
    {
      icon: '💗',
      title: 'Emotional Stability',
      description: 'Cultivate equanimity and emotional resilience'
    },
    {
      icon: '🔍',
      title: 'Self-Awareness',
      description: 'Deepen understanding of your true nature and patterns'
    }
  ];

  const poses = [
    { name: 'Breath Awareness', sanskrit: 'Anapanasati' },
    { name: 'Body Scan', sanskrit: 'Kayanupassana' },
    { name: 'Loving-Kindness', sanskrit: 'Metta Bhavana' },
    { name: 'Mantra Meditation', sanskrit: 'Japa Dhyana' },
    { name: 'Mindfulness', sanskrit: 'Vipassana' },
    { name: 'Chakra Meditation', sanskrit: 'Chakra Dhyana' }
  ];
  ...
  return (
    <div className={styles.hathaYogaPage}>
        ...
        <div className="container">
          <div className="row align-items-center min-vh-100">
            <div className="col-lg-8 mx-auto text-center">
              <div className={styles.heroBadge}>Inner Journey</div>
              <h1 className={`display-3 fw-bold mb-4 ${styles.heroTitle}`}>
                Meditation
              </h1>
              <p className={`lead ${styles.heroDescription}`}>
                Meditation practices cultivate inner silence, concentration, emotional stability, 
                and heightened self-awareness through guided and self-practice techniques.
              </p>
      ...
      <section className={`py-5 ${styles.posesSection}`}>
        <div className="container py-5">
          <div className="text-center mb-5">
            <h2 className={styles.sectionTitle}>Meditation Techniques</h2>
            <div className={`${styles.titleUnderline} bg-white`}></div>
            <p className="text-white-50 mt-3">Diverse approaches to cultivate inner peace</p>
          </div>
          <div className="row g-4">
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 mb-4 mb-lg-0">
              <div className={styles.practiceImageWrapper}>
                <img src={Practice} alt="Meditation Practice"/>
              </div>
            </div>
              ...
              <div className={styles.practiceContent}>
                <div className={styles.practiceItem}>
                  ...
                  <div>
                    ...
                    <p>Learn through structured instruction and support</p>
                  </div>
                </div>
                <div className={styles.practiceItem}>
                  ...
                  <div>
                    <h5>Self-Practice</h5>
                    <p>Develop independence in your meditation journey</p>
                  </div>
                </div>
                <div className={styles.practiceItem}>
                  <div className={styles.practiceIcon}>🕉️</div>
                  <div>
                    <h5>Deep Stillness</h5>
                    <p>Access profound states of peace and consciousness</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className={styles.ctaCard}>
            <div className="row align-items-center">
              <div className="col-lg-8">
                <h2 className="text-white mb-3">Begin Your Meditation Journey</h2>
                <p className="text-white-50 mb-0">
                  Discover inner peace and transform your mind through meditation
                </p>
              </div>
