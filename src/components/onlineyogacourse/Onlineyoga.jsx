    ...
    <div className={styles.container}>
      ...
      <section className={styles.heroBanner}>
        ...
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroSubtitle}>
            Yoga is commonly believed to be a physical practice. While asanas (postures) are important, yoga is a vast and deep subject that can dramatically improve the quality of our lives. If you've ever had a casual interest in yoga, or are considering pursuing a career as a yoga teacher, this course is meant for you.
          </p>
        ...
        <svg className={styles.lotusDecor} viewBox="0 0 150 150" xmlns="http://www.w3.org/2000/svg">
      ...
      <section className={styles.classesSection}>
        <div className={styles.sectionDivider}>
          <svg className={styles.yogaIcon} viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
            <circle cx="25" cy="15" r="5" fill="currentColor"/>
            <path d="M15 25 L25 20 L35 25 M25 20 L25 35 M20 35 L25 35 L30 35" stroke="currentColor" strokeWidth="2" fill="none"/>
          </svg>
        </div>
          ...
          {yogaClasses.map((yogaClass) => (
            <div key={yogaClass.id} className={styles.classCard}>
              <div className={styles.classImageWrapper}>
                <img src={yogaClass.image} alt={yogaClass.title} className={styles.classImage} />
              </div>
              <div className={styles.classContent}>
                ...
                <button className={styles.bookButton} onClick={() => navigate('/BookingForm')}>Book Now</button>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className={styles.benefitsContainer}>
          ...
          <div className={styles.benefitsContent}>
            ...
            <h2 className={styles.benefitsTitle}>
              Benefits Of Yoga from <span className={styles.brandHighlight}>Hatha Yogashram</span>
            </h2>
      ...
      <section className={styles.finalCta}>
        <div className={styles.ctaContent}>
          ...
          <h2 className={styles.ctaTitle}>
            Embark Your Yogic Journey with Yoga Alliance® Certified Yoga Teacher Training School in Rishikesh, India
          </h2>
          <button className={styles.ctaMainButton} onClick={() => navigate('/BookingForm')}>Book Now</button>
        </div>
      </section>
