...
const OnlineYTTC = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <svg className={styles.omDecor1} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        <path d="M100 20 Q130 40 140 70 Q150 100 140 130 Q130 160 100 180 Q70 160 60 130 Q50 100 60 70 Q70 40 100 20 M80 60 Q90 70 100 70 Q110 70 120 60 M85 90 Q92 100 100 105 Q108 100 115 90 M75 120 Q85 135 100 140 Q115 135 125 120" 
              stroke="currentColor" 
              strokeWidth="2" 
              fill="none" />
      </svg>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          <div className={styles.omSymbol}>
            <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
              <path d="M50 10 Q65 20 70 35 Q75 50 70 65 Q65 80 50 90 Q35 80 30 65 Q25 50 30 35 Q35 20 50 10 M40 30 Q45 35 50 35 Q55 35 60 30 M42.5 45 Q46 50 50 52.5 Q54 50 57.5 45 M37.5 60 Q42.5 67.5 50 70 Q57.5 67.5 62.5 60" 
                    fill="none" 
                    stroke="currentColor" 
                    strokeWidth="2.5"/>
            </svg>
          ...
          <p className={styles.heroSubtitle}>
            Our Online Yoga Teacher Training Course (TTC) brings the transformative essence of traditional Hatha Yoga directly to you, no matter where you are in the world.
          </p>
        ...
        {/* Swastik Decoration */}
        <svg className={styles.swastikDecor} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
            ...
            <div key={course.id} className={styles.courseCard}>
              <div className={styles.courseImageWrapper}>
                ...
                <div className={styles.courseOverlay}>
                  <svg className={styles.courseOm} viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
                    <path d="M30 6 Q39 12 42 21 Q45 30 42 39 Q39 48 30 54 Q21 48 18 39 Q15 30 18 21 Q21 12 30 6 M24 18 Q27 21 30 21 Q33 21 36 18 M25.5 27 Q27.6 30 30 31.5 Q32.4 30 34.5 27 M22.5 36 Q25.5 40.5 30 42 Q34.5 40.5 37.5 36" 
                          fill="none" 
                          stroke="currentColor" 
                          strokeWidth="1.5"/>
                  </svg>
      ...
      <section className={styles.bookingSection}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionDescription}>
            At Hatha Yogashram, we believe yoga is more than just a practice—it's a way of life. Nestled in the serene foothills of the Himalayas, our ashram has been a sanctuary for seekers for years.
          </p>
        </div>
            ...
            {[
              {
                ...
                description: 'Learn traditional Hatha Yoga from experienced instructors rooted in the lineage of Rishikesh, the Yoga Capital of the World.',
              },
              {
                title: 'Flexible Learning',
                description: 'Study at your own pace with pre-recorded sessions, live classes, and interactive Q&A opportunities.',
              },
              {
                title: 'Global Recognition',
                description: 'Earn a Yoga Alliance-approved certificate upon completion, empowering you to teach yoga worldwide.',
              },
              {
                title: 'Comprehensive Curriculum',
                description: 'Master asanas, pranayama, meditation, anatomy, philosophy, and teaching methodology.',
              },
            ].map((benefit, index) => (
      ...
      <section className={styles.certificationSection}>
        ...
        <div className={styles.certContent}>
          <p className={styles.certText}>
            At Hatha Yogashram, our core focus lies in the practice of traditional Hatha Yoga. We are the best yoga school in India regarding Hatha Yoga, as it forms a crucial foundation for balancing the Nadis (energy channels). To meet certification standards, our Hatha Yoga training is enriched with studies in Yoga Anatomy & Physiology, Adjustment & Alignment of Asanas, Pranayama (the yogic art of breathing), traditional Yoga Philosophy, Meditation techniques, Ayurveda, and Mantra chanting.
          </p>
          
          <p className={styles.certText}>
            Our main instructors, who are 'International Yoga Certified,' are among the <strong>best yoga teacher training in India</strong> and globally. They inspire students to reach their fullest potential, elevating their practice to new heights. At Hatha Yogashram, we support students at every step, offering personalized attention in small group settings. This ensures that students gain the knowledge, skills, and experience needed to achieve their personal yoga goals.
          </p>
        </div>

        {/* Decorative Lotus Elements */}
        <svg className={styles.lotusLeft} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className={styles.lotusRight} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
          <g opacity="0.15" stroke="currentColor" strokeWidth="1.5" fill="none">
            <path d="M50 80 Q40 60 40 40 Q40 30 50 20" />
            <path d="M50 80 Q60 60 60 40 Q60 30 50 20" />
            <path d="M30 70 Q35 60 40 50" />
          ...
          {[
            {
              step: '01',
              title: 'Enroll Online',
              description: 'Choose your preferred course and complete the simple registration process.',
            },
            {
              step: '02',
              title: 'Access Materials',
              description: 'Gain instant access to our user-friendly online platform with videos, manuals, and resources.',
            },
            {
              step: '03',
              title: 'Learn & Practice',
              description: 'Follow the structured curriculum at your pace, with the option to join live sessions.',
            },
            {
              step: '04',
              title: 'Get Certified',
              description: 'Complete assignments, quizzes, and a final teaching demonstration to earn your certification.',
            },
          ].map((item, index) => (
      ...
      <section className={styles.finalCta}>
        <div className={styles.ctaContent}>
          <svg className={styles.ctaOm} viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg">
            <path d="M60 12 Q78 24 84 42 Q90 60 84 78 Q78 96 60 108 Q42 96 36 78 Q30 60 36 42 Q42 24 60 12 M48 36 Q54 42 60 42 Q66 42 72 36 M51 54 Q55.2 60 60 63 Q64.8 60 69 54 M45 72 Q51 81 60 84 Q69 81 75 72" 
                  fill="none" 
                  stroke="currentColor" 
                  strokeWidth="3"/>
          </svg>
          ...
          <p className={styles.ctaText}>
            Enroll now and take the first step toward becoming a certified yoga teacher with Hatha Yogashram!
          </p>
          <button className={styles.ctaButton} onClick={() => navigate('/contact-us')}>
      ...
      <svg className={styles.omDecor2} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        <path d="M100 20 Q130 40 140 70 Q150 100 140 130 Q130 160 100 180 Q70 160 60 130 Q50 100 60 70 Q70 40 100 20 M80 60 Q90 70 100 70 Q110 70 120 60 M85 90 Q92 100 100 105 Q108 100 115 90 M75 120 Q85 135 100 140 Q115 135 125 120" 
              stroke="currentColor" 
              strokeWidth="2" 
              fill="none" 
