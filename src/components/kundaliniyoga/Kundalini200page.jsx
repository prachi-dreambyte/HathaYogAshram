    ...
    <div className={styles.page}>
        ...
        <div className={styles.heroContent}>
          ...
          <div className={styles.heroText}>
            ...
            <p className={styles.heroSubtitle}>
              Transform through ancient wisdom • Rise your consciousness • Awaken dormant energy
            </p>
        ...
        <div className={styles.container}>
          <div className={styles.floatingCards}>
            <div className={styles.floatCard}>
              ...
              <p>Train in Rishikesh, the spiritual heart of yoga beside the holy Ganges</p>
            </div>
            <div className={styles.floatCard}>
              <div className={styles.cardIcon}>👨‍🏫</div>
              <h3>Expert Masters</h3>
              <p>Learn from Himalayan tradition teachers with 30+ years experience</p>
            </div>
            <div className={styles.floatCard}>
              <div className={styles.cardIcon}>📜</div>
              <h3>Yoga Alliance</h3>
              <p>Internationally recognized RYT-200 certification upon completion</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className={styles.overviewSection}>
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            <span className={styles.sectionLabel}>Discover the Power Within</span>
          ...
          <div className={styles.overviewGrid}>
            <div className={styles.overviewContent}>
              <p className={styles.leadText}>
                Kundalini is the hidden force that exists within human beings—a latent energy 
                asleep at the root of our spines. When awakened, it courses through our body's 
                centers and chakras, cleansing us from negativity, stress, anxiety, and depression.
              </p>
              ...
              <div className={styles.highlights}>
                <div className={styles.highlight}>
                  ...
                  <div>
                    ...
                    <p>Works faster than other yoga styles for spiritual development</p>
                  </div>
                </div>
                <div className={styles.highlight}>
                  <div className={styles.highlightIcon}>🌈</div>
                  <div>
                    ...
                    <p>Physical postures, breathing, mantra, meditation & philosophy</p>
                  </div>
                </div>
                <div className={styles.highlight}>
                  <div className={styles.highlightIcon}>💫</div>
                  <div>
                    ...
                    <p>Experience inner joy, fearlessness, mindfulness and self-awareness</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.chakrasList}>
            <div className={styles.chakraItem}>
              <div className={styles.chakraCircle} style={{background: 'linear-gradient(135deg, #C41E3A 0%, #8B1F3F 100%)'}}>
                <span className={styles.chakraNumber}>1</span>
              </div>
              <div className={styles.chakraContent}>
                <h3>Muladhara</h3>
                <p className={styles.chakraLabel}>Root Chakra</p>
                <p>Foundation of physical and spiritual being, connecting body and soul at the base of spine</p>
              </div>
            </div>

            <div className={styles.chakraItem}>
              <div className={styles.chakraCircle} style={{background: 'linear-gradient(135deg, #FF6B35 0%, #D84315 100%)'}}>
                <span className={styles.chakraNumber}>2</span>
              </div>
              <div className={styles.chakraContent}>
                <h3>Swadhishthana</h3>
                <p className={styles.chakraLabel}>Sacral Chakra</p>
                <p>Center of creative and sexual energy, controlling desire and procreative power</p>
              </div>
            </div>

            <div className={styles.chakraItem}>
              <div className={styles.chakraCircle} style={{background: 'linear-gradient(135deg, #FDB813 0%, #F57F17 100%)'}}>
                <span className={styles.chakraNumber}>3</span>
              </div>
              <div className={styles.chakraContent}>
                <h3>Manipura</h3>
                <p className={styles.chakraLabel}>Solar Plexus Chakra</p>
                <p>Power seat below the navel, controlling physical and physiological wellbeing</p>
              </div>
            </div>

            <div className={styles.chakraItem}>
              <div className={styles.chakraCircle} style={{background: 'linear-gradient(135deg, #4CAF50 0%, #2E7D32 100%)'}}>
                <span className={styles.chakraNumber}>4</span>
              </div>
              <div className={styles.chakraContent}>
                <h3>Anahata</h3>
                <p className={styles.chakraLabel}>Heart Chakra</p>
                <p>Center of emotions in the chest, opening deep happiness and peace when awakened</p>
              </div>
            </div>

            <div className={styles.chakraItem}>
              <div className={styles.chakraCircle} style={{background: 'linear-gradient(135deg, #2196F3 0%, #1565C0 100%)'}}>
                <span className={styles.chakraNumber}>5</span>
              </div>
              <div className={styles.chakraContent}>
                <h3>Vishuddhi</h3>
                <p className={styles.chakraLabel}>Throat Chakra</p>
                <p>Chakra of purity behind throat, awakening brings sweet voice and divine communication</p>
              </div>
            </div>

            <div className={styles.chakraItem}>
              <div className={styles.chakraCircle} style={{background: 'linear-gradient(135deg, #673AB7 0%, #4527A0 100%)'}}>
                <span className={styles.chakraNumber}>6</span>
              </div>
              <div className={styles.chakraContent}>
                <h3>Ajna</h3>
                <p className={styles.chakraLabel}>Third Eye Chakra</p>
                <p>Command center between eyebrows, providing visions, light flashes and deep stillness</p>
              </div>
            </div>

            <div className={styles.chakraItem}>
              <div className={styles.chakraCircle} style={{background: 'linear-gradient(135deg, #9C27B0 0%, #6A1B9A 100%)'}}>
                <span className={styles.chakraNumber}>7</span>
              </div>
              <div className={styles.chakraContent}>
                <h3>Sahasrara</h3>
                <p className={styles.chakraLabel}>Crown Chakra</p>
                <p>Supreme state at top of skull, opening tremendous powers and state of divine trance</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className={styles.tabContent}>
                ...
                <div className={styles.tabPane}>
                  ...
                  <div className={styles.curriculumGrid}>
                    <div className={styles.curriculumCard}>
                      ...
                      <p>Traditional postures to awaken energy centers and prepare body for awakening</p>
                    </div>
                    <div className={styles.curriculumCard}>
                      <h4>🌬️ Pranayama & Kriya</h4>
                      <p>Breathing practices and kriyas for purification and energy activation</p>
                    </div>
                    <div className={styles.curriculumCard}>
                      <h4>🎵 Mantra & Kirtan</h4>
                      <p>Sacred chanting and sound vibrations to elevate consciousness</p>
                    </div>
                    <div className={styles.curriculumCard}>
                      <h4>🧠 Meditation Techniques</h4>
                      <p>Chakra meditation, Kundalini awakening and consciousness expansion</p>
                    </div>
                    <div className={styles.curriculumCard}>
                      <h4>📚 Tantra Philosophy</h4>
                      <p>Ancient wisdom of chakras, nadis, and energy body systems</p>
                    </div>
                    <div className={styles.curriculumCard}>
                      <h4>👥 Teaching Methodology</h4>
                      <p>How to guide students safely through Kundalini awakening journey</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              {activeTab === 'asanas' && (
                <div className={styles.tabPane}>
                  ...
                  <ul className={styles.curriculumList}>
                    ...
                    <li>Warrior Poses (Virabhadrasana I, II, III) - Strengthening masculine energy</li>
                    <li>Cobra Pose (Bhujangasana) - Awakening heart chakra</li>
                    <li>Bow Pose (Dhanurasana) - Improving digestion and energy flow</li>
                    <li>Camel Pose (Ustrasana) - Arousing Manipura chakra</li>
                    <li>Bridge Pose (Setu Bandhasana) - Connecting lower and upper chakras</li>
                    <li>Shoulder Stand - Rejuvenating brain cells</li>
                    <li>Spinal Twists (Ardha Matsyendrasana) - Elongating spine</li>
                    <li>Forward Bends (Paschimottanasana) - Increasing flexibility</li>
              ...
              {activeTab === 'pranayama' && (
                <div className={styles.tabPane}>
                  ...
                  <ul className={styles.curriculumList}>
                    <li>Nadi Shodhana - Balancing both hemispheres and activating Sushumna</li>
                    ...
                    <li>Bandhas (Energy Locks) - Moola, Uddiyana, Jalandhara</li>
                  </ul>
                </div>
              )}
              ...
              {activeTab === 'meditation' && (
                <div className={styles.tabPane}>
                  ...
                  <ul className={styles.curriculumList}>
                    <li>Chakra Awareness Meditation - Awakening each energy center</li>
                    <li>Kundalini Awakening Meditation - Raising dormant energy</li>
                    <li>Trataka - Third eye activation through candle gazing</li>
              ...
              {activeTab === 'philosophy' && (
                <div className={styles.tabPane}>
                  ...
                  <ul className={styles.curriculumList}>
                    ...
                    <li>Seven Chakras - Location, qualities, and awakening methods</li>
                    <li>Nadis - 72,000 energy channels, focus on Ida, Pingala, Sushumna</li>
                    <li>Granthis - Three psychic knots blocking energy flow</li>
                    <li>Kundalini Awakening Process - Safe practices and precautions</li>
                    ...
                    <li>Kundalini Anatomy - Understanding subtle body systems</li>
                  </ul>
                </div>
              )}
            </div>
      ...
      <section className={styles.scheduleSection}>
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionDesc}>
              Immerse yourself in yogic discipline with our carefully structured daily routine
            </p>
          </div>
          ...
          <div className={styles.scheduleTimeline}>
            <div className={styles.scheduleItem}>
              ...
              <div className={styles.scheduleContent}>
                ...
                <p>Wake up to the sound of temple bells and prepare for the day</p>
              </div>
            </div>
      ...
      <section className={styles.ctaSection}>
        <div className={styles.ctaContent}>
          ...
          <p>Join us in Rishikesh for a life-transforming journey of spiritual awakening</p>
