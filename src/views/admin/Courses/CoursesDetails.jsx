    ...
    <div className="container pt-5 mt-5">
      ...
      {!showForm ? (
        ...
        <form onSubmit={handleSubmit} className="card p-4 shadow-sm">
          ...
          <h6 className="mt-4 mb-3 text-primary">Certificate Section</h6>
          <div className="row">
            <div className="col-md-6 mb-3">
              <label className="form-label fw-semibold">Hero Badge</label>
              <input
                type="text"
                className="form-control"
                value={contentData.certificate.hero.badgeText}
                onChange={(e) =>
                  updateCertificateSection("hero", "badgeText", e.target.value)
                }
              />
            </div>
            <div className="col-md-6 mb-3">
              ...
              <input
                type="text"
                className="form-control"
                value={contentData.certificate.hero.title}
                onChange={(e) => updateCertificateSection("hero", "title", e.target.value)}
              />
            </div>
            <div className="col-md-6 mb-3">
              ...
              <input
                type="text"
                className="form-control"
                value={contentData.certificate.hero.subtitle}
                onChange={(e) =>
                  updateCertificateSection("hero", "subtitle", e.target.value)
                }
              />
            </div>
            <div className="col-md-6 mb-3">
              ...
              <input
                type="text"
                className="form-control"
                value={contentData.certificate.hero.description}
                onChange={(e) =>
                  updateCertificateSection("hero", "description", e.target.value)
                }
              />
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-md-6 mb-3">
              ...
              <input
                type="text"
                className="form-control"
                value={contentData.certificate.program.title}
                onChange={(e) =>
                  updateCertificateSection("program", "title", e.target.value)
                }
              />
            </div>
            <div className="col-md-6 mb-3">
              <label className="form-label fw-semibold">Program Duration</label>
              <input
                type="text"
                className="form-control"
                value={contentData.certificate.program.duration}
                onChange={(e) =>
                  updateCertificateSection("program", "duration", e.target.value)
                }
              />
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-md-6 mb-3">
              <label className="form-label fw-semibold">Offer Badge</label>
              <input
                type="text"
                className="form-control"
                value={contentData.certificate.pricing.offerBadge}
                onChange={(e) =>
                  updateCertificateSection("pricing", "offerBadge", e.target.value)
                }
              />
            </div>
            <div className="col-md-6 mb-3">
              <label className="form-label fw-semibold">Regular Label</label>
              <input
                type="text"
                className="form-control"
                value={contentData.certificate.pricing.regularLabel}
                onChange={(e) =>
                  updateCertificateSection("pricing", "regularLabel", e.target.value)
                }
              />
            </div>
            <div className="col-md-6 mb-3">
              ...
              <input
                type="text"
                className="form-control"
                value={contentData.certificate.pricing.currentPrice}
                onChange={(e) =>
                  updateCertificateSection("pricing", "currentPrice", e.target.value)
                }
              />
            </div>
            <div className="col-md-6 mb-3">
              <label className="form-label fw-semibold">Pay Notice</label>
              <input
                type="text"
                className="form-control"
                value={contentData.certificate.pricing.payNotice}
                onChange={(e) =>
                  updateCertificateSection("pricing", "payNotice", e.target.value)
                }
              />
            </div>
            <div className="col-md-6 mb-3">
              <label className="form-label fw-semibold">CTA Label</label>
              <input
                type="text"
                className="form-control"
                value={contentData.certificate.pricing.ctaLabel}
                onChange={(e) =>
                  updateCertificateSection("pricing", "ctaLabel", e.target.value)
                }
              />
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-md-6 mb-3">
              <label className="form-label fw-semibold">Certification Title</label>
              <input
                type="text"
                className="form-control"
                value={contentData.certificate.certification.title}
                onChange={(e) =>
                  updateCertificateSection("certification", "title", e.target.value)
                }
              />
            </div>
            <div className="col-md-6 mb-3">
              <label className="form-label fw-semibold">Certification Name</label>
              <input
                type="text"
                className="form-control"
                value={contentData.certificate.certification.name}
                onChange={(e) =>
                  updateCertificateSection("certification", "name", e.target.value)
                }
              />
            </div>
          </div>
          <div className="mb-3">
            <label className="form-label fw-semibold">Certification Text</label>
            <textarea
              className="form-control"
              rows={2}
              value={contentData.certificate.certification.text}
              onChange={(e) =>
                updateCertificateSection("certification", "text", e.target.value)
              }
            />
          </div>
          ...
          <div className="row">
            <div className="col-md-6 mb-3">
              <label className="form-label fw-semibold">Eligibility Title</label>
              <input
                type="text"
                className="form-control"
                value={contentData.certificate.eligibility.title}
                onChange={(e) =>
                  updateCertificateSection("eligibility", "title", e.target.value)
                }
              />
            </div>
            <div className="col-md-6 mb-3">
              <label className="form-label fw-semibold">Inclusions Title</label>
              <input
                type="text"
                className="form-control"
                value={contentData.certificate.inclusions.title}
                onChange={(e) =>
                  updateCertificateSection("inclusions", "title", e.target.value)
                }
              />
            </div>
          </div>

          <label className="form-label fw-semibold">Eligibility Items</label>
          {contentData.certificate.eligibility.items.map((item, index) => (
            <div key={index} className="d-flex gap-2 mb-2">
              <input
                type="text"
                className="form-control"
                value={item}
                onChange={(e) => updateCertificateEligibilityItem(index, e.target.value)}
              />
              <button
                type="button"
                className="btn btn-outline-danger"
                onClick={() => removeCertificateEligibilityItem(index)}
              >
                Remove
              </button>
            </div>
          ...
          <button
            type="button"
            className="btn btn-outline-primary mb-3"
            onClick={addCertificateEligibilityItem}
          >
            + Add Eligibility Item
          </button>

          <label className="form-label fw-semibold">Inclusion Items</label>
          {contentData.certificate.inclusions.items.map((item, index) => (
            <div key={index} className="d-flex gap-2 mb-2">
              <input
                type="text"
                className="form-control"
                ...
                value={item.icon}
                onChange={(e) =>
                  updateCertificateInclusionItem(index, "icon", e.target.value)
                }
              />
              <input
                type="text"
                ...
                value={item.text}
                onChange={(e) =>
                  updateCertificateInclusionItem(index, "text", e.target.value)
                }
              />
              <button
                type="button"
                className="btn btn-outline-danger"
                onClick={() => removeCertificateInclusionItem(index)}
              >
                Remove
              </button>
            </div>
          ...
          <button
            type="button"
            className="btn btn-outline-primary mb-3"
            onClick={addCertificateInclusionItem}
          >
            + Add Inclusion
          </button>

          <h6 className="mt-4 mb-3 text-primary">Location Section</h6>
          <div className="row">
            <div className="col-md-6 mb-3">
              <label className="form-label fw-semibold">Location Title</label>
              <input
                type="text"
                className="form-control"
                value={contentData.certificate.location.title}
                onChange={(e) =>
                  updateCertificateSection("location", "title", e.target.value)
                }
              />
            </div>
            <div className="col-md-6 mb-3">
              ...
              <input
                type="text"
                className="form-control"
                value={contentData.certificate.location.school}
                onChange={(e) =>
                  updateCertificateSection("location", "school", e.target.value)
                }
              />
            </div>
            <div className="col-md-12 mb-3">
              ...
              <input
                type="text"
                className="form-control"
                value={contentData.certificate.location.address}
                onChange={(e) =>
                  updateCertificateSection("location", "address", e.target.value)
                }
              />
            </div>
            <div className="col-md-12 mb-3">
              ...
              <textarea
                className="form-control"
                rows={2}
                value={contentData.certificate.location.description}
                onChange={(e) =>
                  updateCertificateSection("location", "description", e.target.value)
                }
              />
            </div>
            <div className="col-md-12 mb-3">
              <label className="form-label fw-semibold">Map URL</label>
              <input
                type="text"
                className="form-control"
                value={contentData.certificate.location.mapSrc}
                onChange={(e) =>
                  updateCertificateSection("location", "mapSrc", e.target.value)
                }
              />
            </div>
          </div>
